...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Please fill up the product information here :</p>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productStatus" id="status" value="active" />New</label>
            <label class="checkbox-inline"><form:radiobutton path="productStatus" id="status" value="inactive" />Used</label>
        </div>
        <div class="form-group">
            <label for="unitInStock">Unit In Stock</label>
            <form:input path="unitStock" id="unitInStock" class="form-control" value="${product.unitStock}"/>
        </div>
        <div class="form-group">
